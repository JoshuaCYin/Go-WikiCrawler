...
**Go-WikiCrawler** is a web crawler and data visualizer built in Go. It recursively scrapes Wikipedia category pages (specifically universities and colleges) to build an interactive relationship graph and statistical demographic charts.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/yourusername/Go-WikiCrawler.git
   cd Go-WikiCrawler
   ```
...
## License
This project was developed for **CIS-336 Programming Languages**. Use for educational purposes. 
